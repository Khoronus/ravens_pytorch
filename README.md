# Ravens - Transporter Networks (Pytorch)

An attempted Ravens implementation in pytorch.<br>
Trained the following model. Poor test result :(.<br>
(a) **block-insertion**: pick up the L-shaped red block and place it into the L-shaped fixture.<br>

PS: Any help or comment for fixing bugs/issues is more than welcome!<br>
...
python ravens/demos.py --assets_root=./ravens/environments/assets/ --disp=True --task=towers-of-hanoi --mode=test --n=100
...
python ravens/train.py --task=towers-of-hanoi --agent=transporter --n_demos=10
```
